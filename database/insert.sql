...
INSERT INTO `webshop`.`product` (`product_id`, `subcategorie_id`, `name`, `description`, `price`) 
VALUES (4, 2, 'Google One', 'Erweiterter Cloud-Speicher von Google', '3.99');
INSERT INTO `webshop`.`product` (`product_id`, `subcategorie_id`, `name`, `description`, `price`) 
VALUES (5, 2, 'Dropbox Plus', 'Erweiterte Funktionen für Dropbox', '9.99');
INSERT INTO `webshop`.`product` (`product_id`, `subcategorie_id`, `name`, `description`, `price`) 
VALUES (6, 2, 'Microsoft 365', 'Umfassendes Produktivitätspaket', '12.39');
