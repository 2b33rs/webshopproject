...
CREATE TABLE IF NOT EXISTS `webshop`.`subcategorie` (
  ...
  CONSTRAINT `fk_subcategorie_categorie1` FOREIGN KEY (`categroie_id`) REFERENCES `webshop`.`categorie` (`categroie_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS `webshop`.`orders` (
  ...
  CONSTRAINT `fk_orders_user1` FOREIGN KEY (`user_id`) REFERENCES `webshop`.`user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE IF NOT EXISTS `webshop`.`orders_products` (
  ...
  CONSTRAINT `fk_orders_products_orders1` FOREIGN KEY (`orders_id`) REFERENCES `webshop`.`orders` (`orders_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_orders_products_products1` FOREIGN KEY (`products_id`) REFERENCES `webshop`.`products` (`products_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
);
